...
const ChatInterface = ({ messages, addMessage, resetMode }) => {
    ...
    return (
        <div className="flex flex-col h-full">
            {/* Header */}
            <header className="backdrop-blur-xl bg-white/5 border-b border-white/10 px-4 md:px-8 py-4 flex justify-between items-center">
                <div>
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-3 md:px-4 py-2 text-xs md:text-sm bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all duration-300 backdrop-blur-sm border border-white/10 hover:border-white/20 group"
            ...
            <div className="flex-1 overflow-y-auto px-4 md:px-8 py-4 md:py-6 space-y-4 md:space-y-6 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
                <div className="max-w-5xl mx-auto space-y-4 md:space-y-6">{messages.map((message, index) => (
                    <div
                        key={index}
